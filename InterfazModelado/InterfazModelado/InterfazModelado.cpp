...
double* apretarBoton2(){//int numcol, int numrow, double value1, double value2, double value3, int lowerb, int upperb) {
  const int numcols = 3; //x0,x1,x2
  const int numrows = 1;
  double obj[] = { 1.0, 1.0, 1.0}; // obj: Max x0 + x1 +x2
...
double* apretarBoton2(int numcol, int numrow, double value1, double value2, double value3, double lowerb, double upperb) {
  const int numcols = numcol; //x0,x1,x2
  ...
  int start[] = {0, 1, 2, 3};      // where in index columns start (?)
  int index[] = {0, 0, 0};         // row indexs for the columns
  double values[] = {value1, value2, value3}; // the values in the sparse matrix (values of the constants)
  double rowlb[]  = {lowerb}; //lower bound
  double rowub[]  = {upperb}; //upper bound
